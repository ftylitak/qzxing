...
ExpandedPair::ExpandedPair(DataCharacter leftChar, DataCharacter rightChar, QSharedPointer<FinderPattern> finderPattern)
    : m_leftChar(leftChar),
...
ExpandedPair::ExpandedPair(const ExpandedPair *other)
{
    ...
    m_finderPattern = other != nullptr ? other->m_finderPattern : QSharedPointer<FinderPattern>();
}
...
QSharedPointer<FinderPattern> ExpandedPair::getFinderPattern()
{
