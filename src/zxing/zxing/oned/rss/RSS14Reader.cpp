...
Ref<Result> RSS14Reader::constructResult(Pair leftPair, Pair rightPair)
{
...
Pair RSS14Reader::decodePair(Ref<BitArray> row, boolean right, int rowNumber, DecodeHints hints)
{
    try {
...
DataCharacter RSS14Reader::decodeDataCharacter(Ref<BitArray> row, FinderPattern pattern, boolean outsideChar)
{
...
void RSS14Reader::adjustOddEvenCounts(boolean outsideChar, int numModules)
{
